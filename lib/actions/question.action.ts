...
import { GetQuestionsParams,CreateQuestionParams, GetQuestionByIdParams, QuestionVoteParams, DeleteQuestionParams, EditQuestionParams, RecommendedParams } from './shared.type'
...
// create an interaction record for the user's ask_queston action
await Interaction.create({
  user:author,
  question:qusetion._id,
  action:"ask_question",
  tags:tagDocuments
})
